...
public abstract class Datum<DATUM,D extends Datum<DATUM,D,V>,V extends Envoy<DATUM,D,V>> implements Serializable {
    ...
    static class DatumResource<S extends Scheme<S,L>,L extends Library<S,L>,D extends dev.inward.matrix.Datum<S,L,D,E,A>, E extends DatumReference<S,L,D,E,A>,A extends DatumAttributes<S,L,D,E,A>> extends Resource<S,L,D,E,A> {
