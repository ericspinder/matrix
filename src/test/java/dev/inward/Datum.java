...
public abstract class Datum<DATUM,D extends Datum<DATUM,D,V>,V extends Envoy<DATUM,D,V>> implements Serializable {
    ...
    static class DatumConcept<S extends Scheme<S,L>,L extends Authority<S,L>,D extends dev.inward.matrix.concept.item.datum.Datum<S,L,D,E,A>, E extends DatumReferenceWeak<S,L,D,E,A>,A extends DatumView<S,L,D,E,A>> extends Concept<S,L,D,E,A> {
