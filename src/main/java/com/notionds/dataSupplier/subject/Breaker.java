...
public class Breaker<D extends Datum<D,?,I,X>,F extends Fact<F,?,I,X>,I extends Id<I,X>,X extends Context<X>,M extends Breaker<D,F,I,X,M,E>,E extends Throwable> extends Broken<D,F,I,X,M> {
