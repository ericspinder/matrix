...
public class Conditions {
    ...
    public static class Countdown<N,O extends Operational<N,W,T>,W extends Datum<N,O,T>,T extends Container<N,O,W>> extends Timer<N,O,W,T> {
    ...
    public static class SpecificTime<N,O extends Operational<N,W,T>,W extends Datum<N,O,T>,T extends Container<N,O,W>> extends Task<N,O,W,T> {
    ...
    public static class CleanupOnly<N,O extends Operational<N,W,T>,W extends Datum<N,O,T>,T extends Container<N,O,W>> extends Task<N,O,W,T> {
