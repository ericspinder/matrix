...
public abstract class Task<D extends Datum<D,?,?,?>,S extends Sanction<D,?,?,?>,C extends Conditions<D,O,S,C,R,Q>,R extends Result<Q>,Q extends Request> implements Comparable<Task<C,R,Q>>, Serializable {
