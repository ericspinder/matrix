...
public class OutputStreamDatum<O extends Options<OutputStream,W,T>, W extends Datum<OutputStream,O,T>,T extends Container<OutputStream,O,W>> extends OutputStream implements Datum<OutputStream,O,T> {
