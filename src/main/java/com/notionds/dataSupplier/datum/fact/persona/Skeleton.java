...
public final class Skeleton<H extends House<H>,L extends Library<L,?>,Y extends Psyche<H,L,Y,FEST>,FEST extends Manifestation<H,L,Y,FEST>> extends Omnibus<Persona<H,L,Y,FEST>, Heart<H,L,Y,FEST>, Body<H,L,Y,FEST>, Id.SuperEgo<H>, Skeleton<H,L,Y,FEST>,Psyche<H,L,Y,FEST>,Manifestation<H,L,Y,FEST>, PsycheMeta<H,L,Y,FEST>> {
