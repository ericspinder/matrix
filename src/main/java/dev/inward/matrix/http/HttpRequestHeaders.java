...
public enum HttpRequestHeaders implements HttpHeader {
    ...
    Access_Control_Request_Headers("Access-Control-Request-Headers","Initiates a request for cross-origin resource sharing with Origin (below).	Access-Control-Request-Method: GET	Permanent: standard",HttpHeader.DefaultHttpHeader.class),
    ...
    Origin("Origin","Initiates a request for cross-origin resource sharing (asks server for Access-Control-* response fields).	Origin: http://www.example-social-network.com	Permanent: standard	RFC 6454",HttpHeader.DefaultHttpHeader.class),
