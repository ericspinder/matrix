...
public enum HttpResponseHeaders implements HttpHeader {
    ...
    Access_Control_Allow_Headers("Access-Control-Allow-Headers","Specifying which web sites can participate in cross-origin resourceRecord sharing	Access-Control-Allow-Origin: *	Permanent: standard	RFC 7480",DefaultHttpHeader.class),
    ...
    Allow("Allow","Valid methods for a specified resourceRecord. To be used for a 405 Method not allowed	Allow: GET, HEAD	Permanent	RFC 2616, 7231",DefaultHttpHeader.class),
    ...
    Content_Location("Content-Location","An alternate location for the returned data	Content-Location: /index.htm	Permanent	RFC 2616, 4021, 7231",DefaultHttpHeader.class),
    ...
    ETag("ETag","An identifier for a specific version of a resourceRecord, often a message digest	ETag: \"737060cd8c284d8af7ad3082f209582d\"	Permanent	RFC 2616, 7232",DefaultHttpHeader.class),
    ...
    Link("Link","Used to express a typed relationship with another resourceRecord, where the relation type is defined by RFC 5988	Link: </feed>; rel=\"alternate\"[52]	Permanent	RFC 5988",DefaultHttpHeader.class),
    Location("Location","Used in redirection, or when a new resourceRecord has been created. Example 1: Location: http://www.w3.org/pub/WWW/People.html  Example 2: Location: /pub/WWW/People.html    Permanent	RFC 2068, 2616, 7231",DefaultHttpHeader.class),
    P3P("P3P","This field is supposed to set P3P policy, in the form of P3P:CP=\"your_compact_policy\". However, P3P did not take off,[53] most browsers have never fully implemented it, a lot of websites set this field with fake policy text, that was enough to fool browsers the existence of P3P policy and grant permissions for third party cookies.	P3P: CP=\"This is not a P3P policy! See https://en.wikipedia.org/wiki/Special:CentralAutoLogin/P3P for more info.\"	Permanent",DefaultHttpHeader.class),
    ...
    Permissions_Policy("Permissions-Policy","To allow or disable different features or APIs of the browser.	Permissions-Policy: fullscreen=(), camera=(), microphone=(), geolocation=(), interest-cohort=()[62] Refresh	Used in redirection, or when a new resourceRecord has been created. This refresh redirects after 5 seconds. Header extension introduced by Netscape and supported by most web browsers. Defined by HTML Standard[63]	Refresh: 5; url=http://www.w3.org/pub/WWW/People.html",DefaultHttpHeader.class),
