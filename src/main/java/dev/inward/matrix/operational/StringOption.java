...
public enum StringOption implements Specification.Option<String,StringOption> {
    Management_JMX("com.notionds.jmx.management", "JMX management mBean Implementation", "dev.inward.matrix.fact.notion.concept.dataSupplier.jmx.NotionDsBean"),
