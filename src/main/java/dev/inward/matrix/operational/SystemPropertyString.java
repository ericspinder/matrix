...
public enum SystemPropertyString implements Options.SystemProperty<String, SystemPropertyString> {
    ...
    HTTP_Agent("http.agent","","(default: Java1.4.0) Indicates the User-Agent request header sent in http requests."),
