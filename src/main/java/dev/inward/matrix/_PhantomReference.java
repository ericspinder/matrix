...
public class _PhantomReference<TARGET,V extends View<TARGET,V,M>,M extends Model<TARGET>,C extends Concept<TARGET,V,M>> extends PhantomReference<TARGET> implements Shadow {

    protected final Long sequenceNumber;
    protected final Map<String, Model.InstanceValue<?>> attributes;

    public _PhantomReference(TARGET referent, C concept) {
