...
public abstract class Steward<B extends Librarian<B,DATUM,V,M,R,S>,DATUM,V extends View<B,DATUM,V,M,R,S>,M extends Model<DATUM>,R extends Reference<B,DATUM,V,M,R,S>,S extends Steward<B,DATUM,V,M,R,S>> extends ReferenceQueue<DATUM> {
    ...
    public Steward(Standard standard) {
