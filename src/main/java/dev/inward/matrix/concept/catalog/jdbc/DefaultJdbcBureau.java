...
public final class DefaultJdbcBureau extends JdbcBureau<DefaultJdbcBureau,DefaultJdbcBureauView,DefaultJdbcBureauModel> {
    public DefaultJdbcBureau(String name, boolean readOnly, DefaultJdbcBureauModel defaultJdbcBureauModel, Map<String, Object> attributes, Class<FactView<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>[] supportedFileViews) {
