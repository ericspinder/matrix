...
public class Librarian<F extends Fact<F,K,V,M,R,L,X>,K extends FactKey<F,K,V,M,R,L,X>,V extends FactView<F,K,V,M,R,L,X>,M extends FactModel<F,K,V,M,R,L,X>,R extends Bus<F>,L extends Librarian<F,K,V,M,R,L,X>, X extends Context<F,V,M,L,X>> extends Concept<F,V,M> {
