...
public enum ResourceRecordType implements Meta_I {
    ...
    tlsServerCertificatePublicKey("TLSA",52,"RFC 6698	TLSA certificate association	A record for DANE. RFC 6698 defines \"The TLSA DNS resource record is used to associate a TLS server certificate or public key with the authority name where the record is found, thus forming a 'TLSA certificate association'\"."),
