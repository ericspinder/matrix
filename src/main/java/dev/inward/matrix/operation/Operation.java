...
public abstract class Operation<PATH extends Comparable<PATH>,ID extends Comparable<ID>,I extends AddressedKey<PATH,ID,I,A,R,F>,A extends Addressed<PATH,ID,I,A,R,F>,R extends AddressedReference<PATH,ID,I,A,R,F>,F extends AddressedAttributes<PATH,ID,I,A,R,F>,O extends Operation<PATH,ID,I,A,R,F,O>> implements Comparable<O> {
