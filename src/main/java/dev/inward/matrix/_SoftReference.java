...
public class _SoftReference<TARGET,V extends View<TARGET,V,M>,M extends Model<TARGET>,C extends Concept<TARGET,V,M>> extends SoftReference<TARGET> implements Shadow {

    protected final Long sequenceNumber;
    protected final Map<String, Model.InstanceValue<?>> attributes;

    public _SoftReference(TARGET referent, C concept) {
