...
import dev.inward.crud.SubjectMatter;
...
//    protected final Map<Edition, Registrar> editionRegistrarMap;
    ...
    public SubjectMatter getSubjectMatterServers(Indicia indicia, Instant createInstant, Identity.Ego ego) {
        ...
        SubjectMatter[] allSubjectMatterDates = this.subjectMatterServers.get(makeSubjectMatterKey(indicia.getInternetClass(),indicia.locus()));
