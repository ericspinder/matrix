...
public class ConceptPath<S extends Scheme<S,L>,L extends Library<S,L>,PATH extends Comparable<PATH>,ID extends Comparable<ID>,T extends Concept.Tangible<S,L,PATH,ID,T,C>,C extends Concept<S,L,PATH,ID,T,C>> implements Path {

    protected final C concept;

    public ConceptPath(C concept) {
    ...
    public FileSystem getFileSystem() {
        return this.concept.getIdentity().getCatalog();
    }
    ...
    @Override
    public URI toUri() {
        return URI.create(this.concept.get().getIdentity().toString());
    }
