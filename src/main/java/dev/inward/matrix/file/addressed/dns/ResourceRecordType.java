...
//1103	1109	1117	1123	1129	1151	1153	1163
    DepotCatalogRecord("DEPCR", 1087,"Matrix custom record for Depot Catalog details"),
    DnsCatalogRecord("DNSCR",1091,"Matrix custom record for DNS Catalog details"),
    HttpCatalogRecord("HTPCR",1093, "Matrix custom record for HTTP Catalog details"),
    InfoCatalogRecord("INFCR", 1103, "Matrix custom record for Info Catalog details"),
    LogCatalogRecord("LOGCR", 1097, "Matrix custom record for Log Catalog details"),
    ...
    delegationSigner("DS",43,"RFC 4034	Delegation signer	The record used to identify the DNSSEC signing user of a delegated zone"),
    sshPublicKeyFingerPrint("SSHFP",44,"RFC 4255	SSH Public Key Fingerprint	Resource record for publishing SSH public host user fingerprints in the DNS, in order to aid in verifying the authenticity of the host. RFC 6594 defines ECC SSH keys and SHA-256 hashes. See the IANA SSHFP RR parameters registry for details."),
    ...
    dnsKey("DNSKEY",48,"RFC 4034	DNS Key record	The user record used in DNSSEC. Uses the same format as the KEY record."),
    ...
    tlsServerCertificatePublicKey("TLSA",52,"RFC 6698	TLSA certificate association	A record for DANE. RFC 6698 defines \"The TLSA DNS nameServerRecord record is used to associate a TLS server certificate or public user with the authority name where the record is found, thus forming a 'TLSA certificate association'\"."),
    ...
    openPgpKey("OPENPGPKEY",61,"RFC 7929	OpenPGP public user record	A DNS-based Authentication of Named Entities (DANE) method for publishing and locating OpenPGP public keys in DNS for a specific email address using an OPENPGPKEY DNS nameServerRecord record."),
    ...
    serviceBindingRR("SVCB",64,"IETF Draft	Service Binding	RR that improves performance for clients that need to resolve many resources to access a authority. More user in this IETF Draft by DNSOP Working group and Akamai technologies."),
    httpsBindingRR("HTTPS",65,"IETF Draft	HTTPS Binding	RR that improves performance for clients that need to resolve many resources to access a authority. More user in this IETF Draft by DNSOP Working group and Akamai technologies."),
    ...
    transactionKeyRecord("TKEY",249,"RFC 2930	Transaction Key record	A method of providing keying material to be used with TSIG that is encrypted under the public user in an accompanying KEY RR.[12]"),
