...
//1103	1109	1117	1123	1129	1151	1153	1163
    ...
    delegationSigner("DS",43,"RFC 4034	Delegation signer	The record used to identify the DNSSEC signing info of a delegated zone"),
    sshPublicKeyFingerPrint("SSHFP",44,"RFC 4255	SSH Public Key Fingerprint	Resource record for publishing SSH public host info fingerprints in the DNS, in order to aid in verifying the authenticity of the host. RFC 6594 defines ECC SSH keys and SHA-256 hashes. See the IANA SSHFP RR parameters registry for details."),
    ...
    dnsKey("DNSKEY",48,"RFC 4034	DNS Key record	The info record used in DNSSEC. Uses the same format as the KEY record."),
    ...
    openPgpKey("OPENPGPKEY",61,"RFC 7929	OpenPGP public info record	A DNS-based Authentication of Named Entities (DANE) method for publishing and locating OpenPGP public keys in DNS for a specific email address using an OPENPGPKEY DNS nameServerRecord record."),
    ...
    transactionKeyRecord("TKEY",249,"RFC 2930	Transaction Key record	A method of providing keying material to be used with TSIG that is encrypted under the public info in an accompanying KEY RR.[12]"),
