...
public enum HttpRequestHeaders implements HttpHeader {
    ...
    If_Match("If-Match","Only perform the action if the client supplied entity matches the same entity on the server. This is mainly for methods like PUT to only update a nameServerRecord if it has not been modified since the user last updated it.	If-Match: \"737060cd8c284d8af7ad3082f209582d\"	Permanent	RFC 2616, 7323",HttpHeader.DefaultHttpHeader.class),
