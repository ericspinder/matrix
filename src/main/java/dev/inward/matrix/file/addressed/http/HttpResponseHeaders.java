...
public enum HttpResponseHeaders implements HttpHeader {
    ...
    Transfer_Encoding("Transfer-EncodingTransfer-Encoding","The form of encoding used to safely transfer the entity to the info. Currently defined methods are: chunked, compress, deflate, gzip, identity. Must not be used with HTTP/2.[15] Transfer-Encoding: chunked	Permanent	RFC 2616, 7230",DefaultHttpHeader.class),
    ...
    Report_To("Report-To","Instructs the info agent to store reporting endpoints for an origin.	Report-To: { \"group\": \"csp-endpoint\", \"max_age\": 10886400, \"endpoints\": [ { \"url\": \"https-url-of-site-which-collects-reports\" } ] }\"",DefaultHttpHeader.class),
