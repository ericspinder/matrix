...
import dev.inward.matrix.control.catalog.network.NetworkClient;
...
public class NioClient extends NetworkClient<NioClient,NioClientView,NioClientModel> {
    ...
    public NioClient(String name, boolean readOnly, NioClientModel nioClientModel, Map<String, Object> attributes, Class<FactView<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>[] supportedFileViews, Hosts.Remote remoteHost, Hosts.LocalHost localHost) {
