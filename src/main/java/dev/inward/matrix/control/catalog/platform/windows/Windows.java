...
import dev.inward.matrix.control.catalog.platform.Platform;
...
public class Windows extends Platform<Windows, WindowsView,WindowsBureauModel> {


    public Windows(String name, boolean readOnly, WindowsBureauModel windowsBureauModel, Map<String, Object> attributes, Class<FactView<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>[] supportedFileViews, String rootPath) {
