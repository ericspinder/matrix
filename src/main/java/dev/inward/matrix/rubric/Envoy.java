...
public abstract class Envoy<DATUM,D extends Datum<DATUM,D,E,F,I,X,P>,E extends Envoy<DATUM,D,E,F,I,X,P>,F extends Fact<F,I,X,P>,I extends Identity<I,X>,X extends Context<X>,P extends Diplomat<?,F,?,I,X,?,P>> extends SoftReference<D> implements Comparable<E>, Serializable {
    ...
    public static final class NoOp<DATUM,D extends Datum<DATUM,D,E,F,I,X,P>,E extends Envoy<DATUM,D,E,F,I,X,P>,F extends Fact<F,I,X,P>,I extends Identity<I,X>,X extends Context<X>,P extends Diplomat<?,F,?,I,X,?,P>> extends Envoy<DATUM,D,E,F,I,X,P> {
        ...
        public NoOp(D datum, ReferenceQueue<D> referenceQueue) {
            super(datum, referenceQueue);
        }
    }

    public Envoy(D datum, ReferenceQueue<D> referenceQueue) {
        super(datum, referenceQueue);
    }
