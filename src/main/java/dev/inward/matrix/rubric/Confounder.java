...
public abstract class Confounder<F extends Fact<F,I,X,?>,I extends Identity<I, X>, X extends Context<X>,CORO extends Confounder<Y,F,I,X,CORO>> extends RemoteMatter<F,I,X,CORO> {
