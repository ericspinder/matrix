...
public class Observer<M extends Maker<M,?,?,?,?,?,?,?,?>,IS extends Identity<IS,XS>,XS extends Context<XS>> extends Delegated<Studio<M,IS,XS>,M,Scheduler<M,IS,XS>, Identity.Ego, Context.JVM,Scratch<M,IS,XS>, Observer<M,IS,XS>> {
