...
public class BootLoader extends Fabrication<BootLoader,Boot,Init,Structure,Root> {
    ...
    public BootLoader(Root primogenitor, Map<Standard<?,Boot,Identity.Ego,Context.JVM>, Resource<BootLoader,?,?,?,Boot,Init,Identity.Ego,Context.JVM,Structure,Root>> classResourceMap) {
