...
public class BootLoader extends Fabrication<BootLoader,Boot,Init,Context.JVM,Structure,Root> {
    ...
    public BootLoader(Root primogenitor, Map<Class<?>, Resources<BootLoader,?,?,Boot,Init,Identity.Ego<Context.JVM>,Context.JVM,Structure,Root,Boot,Root,?>> classResourceMap, PlatformAgent agent) {
