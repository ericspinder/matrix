...
public abstract class Representative<F extends Fact<F,I,X>,I extends Identity<I,X>,X extends Context<X>,R extends Representative<F,I,X,R,NI,NX>,NI extends Identity<NI, NX>,NX extends Context<NX>> extends Envoy<F,R> {
