...
public class Hotel extends Industry<Hotel,Room,Desk, Identity.Ego<Context.Service>,Context.Service,Cart,HouseKeeping, Corpus, Prophet> {
    public Hotel(HouseKeeping parent, Map<Standard<?, Room, Identity.Ego<Context.Service>, Context.Service>, Resources<Hotel, ?, ?, ?, Room, Desk, Identity.Ego<Context.Service>, Context.Service, Cart, HouseKeeping, Room, HouseKeeping>> resourceMap) {
