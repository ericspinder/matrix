...
public class Submarine<NP extends Notion<NP, Identity.Ego<Context.JVM>,Context.JVM,PP>,PP extends Primogenitor<?,NP,?,Identity.Ego<Context.JVM>, Context.JVM,?,PP>> extends Bus<Factory_ofPools<NP,PP>,Pool<NP,PP>,Operational_ofPool<NP,PP>, Identity.Ego<Context.JVM>, Context.JVM,Submarine<NP,PP>,LifeGuard<NP,PP>,NP,PP> {
