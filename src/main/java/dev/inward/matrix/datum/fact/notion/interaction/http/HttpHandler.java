...
public class HttpHandler<IA extends Identity<IA,XA>,XA extends Context<XA>> extends Handler<HttpHandler<IA,XA>,HttpInteraction<IA,XA>,HttpDesk<IA,XA>,HttpJournal<IA,XA>,HttpProducer<IA,XA>,HttpResponse<IA,XA>,HttpRequest<IA,XA>,IA,XA> {
    ...
    public HttpHandler(Prophet mortal, Storage storage, Map<Standard<?, HttpInteraction<IA,XA>, Identity.Ego, Context.Ethereal>, Resource<HttpHandler<IA,XA>, ?, ?, ?, HttpInteraction<IA,XA>, HttpDesk<IA,XA>, Identity.Ego, Context.Ethereal, HttpJournal<IA, XA>, HttpProducer<IA, XA>>> standardResourcesMap) {
