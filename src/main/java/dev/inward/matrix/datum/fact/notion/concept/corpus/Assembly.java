...
public class Assembly extends Fabrication<Assembly, Corpus,Mechanical,Sandbox,Prophet> {
    ...
    public Assembly(Prophet primogenitor, Map<Standard<?, Corpus,Identity.Ego,Context.JVM>, Resources<Assembly, ?, ?, ?, Corpus, Mechanical, Identity.Ego, Context.JVM, Sandbox, Prophet>> classResourceMap) {
