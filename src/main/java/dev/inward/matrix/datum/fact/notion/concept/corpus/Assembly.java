...
public class Assembly extends Fabrication<Assembly, Corpus,Mechanical,Sandbox,Prophet> {
    ...
    public Assembly(Prophet mortal, Resources resources, Map<Standard<?, Corpus, Identity.Ego, Context.Ethereal>, Resource<Assembly, ?, ?, ?, Corpus, Mechanical, Identity.Ego, Context.Ethereal, Sandbox, Prophet>> standardResourcesMap) {
