...
public class Hospitality extends Industry<Hospitality,Persona,Psyche,Identity.SuperEgo,Context.Service,Skeleton,Spirit,Assembly,Corpus,Mechanical,Sandbox,Prophet> {
    ...
    public Hospitality(Prophet prophet, Map<Standard<?, Persona, Identity.SuperEgo, Context.Service>, Resources<Hospitality, ?, ?, ?, Persona, Psyche, Identity.SuperEgo, Context.Service, Skeleton, Spirit>> resourceMap) {
