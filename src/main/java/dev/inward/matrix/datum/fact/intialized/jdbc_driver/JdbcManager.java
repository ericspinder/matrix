...
public class JdbcManager extends Manager<JdbcManager, JdbcConnection, JdbcFunctionary, Identity.Ego, Context.Ethereal, JdbcBook, JdbcDelegated, Assembly, Corpus, Mechanical, Sandbox, Prophet> {
    ...
    public JdbcManager(Prophet mortal, Storage storage, Map<Standard<?, JdbcConnection, Identity.Ego, Context.Ethereal>, Resource<JdbcManager, ?, ?, ?, JdbcConnection, JdbcFunctionary, Identity.Ego, Context.Ethereal, JdbcBook, JdbcDelegated>> standardResourcesMap) {
