...
public class Assembly<A extends Assembly<A,H,M,S,P>,H extends House<H,P>,M extends Mechanical<A,H,M,S,P>,S extends Sandbox,P extends Steward<H,P>> extends Industry<A,H,M,Identity.Ghost, Governance.Ethereal,S,P> {
