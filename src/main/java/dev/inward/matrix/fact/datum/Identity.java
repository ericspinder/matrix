...
public abstract class Identity<I extends Identity<I,X>,X extends Context<X>> implements Comparable<I>, Serializable {
    ...
    public static class Extended extends Id {

        protected final UUID uuid;
        public Extended(char persona, Context.Service context, SuperEgo superEgo, String path, UUID uuid) {
            super(persona, context, superEgo, path);
            this.uuid = uuid;
        }
    }
    ...
    public static final class Ego extends Identity<Ego,Context.Ethereal> {
        ...
        public Ego(Context.Ethereal ethereal, UUID uuid) {
            super(Empty,ethereal);
            this.uuid = uuid;
        }
        public Ego(Context.Ethereal ethereal) {
            this(ethereal,UUID.randomUUID());
        }
