...
public class Fingerprint<P extends Tree> extends Matter<Fingerprint, Identity.Gate, Context.Path> {

    protected final PublicKey publicKey;
    protected final String subjectKeyIdentifier;
    protected final P issuer;

    public Fingerprint(Identity.Ego ego, Identity.Gate topicId, Instant createInstant, Indicia indicia, PublicKey publicKey, String subjectKeyIdentifier, Issuer issuer) {
