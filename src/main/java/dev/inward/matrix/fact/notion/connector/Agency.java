...
public class Agency extends Industry<Agency,Connector, Journey,Identity.Ego, Context.Demarc, Passage, Agent, Boot, dev.inward.matrix.fact.notion.concept.boot.Boot, Init, Structure, Root> {
