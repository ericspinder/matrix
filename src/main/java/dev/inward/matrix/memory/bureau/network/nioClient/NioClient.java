...
import dev.inward.matrix.bureau.network.Network;
...
public class NioClient extends Network<NioClientKey,NioClient, NioClientView,NioClientModel,NioClientReference,NioClientGestalt> {
