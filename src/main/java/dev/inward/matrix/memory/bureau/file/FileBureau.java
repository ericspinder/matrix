...
import dev.inward.matrix.bureau.jdbc.JdbcBureau;
import dev.inward.matrix.bureau.jdbc.JdbcBureauModel;
import dev.inward.matrix.bureau.jdbc.JdbcBureauView;
...
public abstract class FileBureau<K extends FileBureauKey<K,I,V,M,R,G>,I extends FileBureau<K,I,V,M,R,G>,V extends FileBureauView<K,I,V,M,R,G>,M extends FileBureauModel<K,I,V,M,R,G>,R extends FileBureauReference<K,I,V,M,R,G>,G extends FileBureauGestalt<K,I,V,M,R,G>> extends Bureau<K,I,V,M,R,G> {
