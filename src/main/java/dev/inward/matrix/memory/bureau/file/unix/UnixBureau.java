...
import dev.inward.matrix.bureau.file.FileBureau;
import dev.inward.matrix.file.FileView;

import java.util.Map;

public abstract class UnixBureau<K extends UnixBureauKey<K,I,V,M,R,G>,I extends UnixBureau<K,I,V,M,R,G>,V extends UnixBureauView<K,I,V,M,R,G>,M extends UnixBureauModel<K,I,V,M,R,G>,R extends UnixBureauReference<K,I,V,M,R,G>,G extends UnixBureauGestalt<K,I,V,M,R,G>> extends FileBureau<K,I,V,M,R,G> {
