...
public class ObservedHost extends Host {
    public ObservedHost(Library library, String target, SocketAddress[] socketAddresses, Properties properties) {
        super(library, target, socketAddresses, properties);
    }
...
//            Host netTld = new ObservedHost(new AddressedKey.Ghost(new Context.Ethereal(netDomain, Terrene.Earth, Zone.InSituDefault)));
//            Domain netRootServer = new Domain("root-servers", netTld);
//            Host netRootServerHost = new ObservedHost(new AddressedKey.Ghost(new Context.Ethereal(netRootServer, Terrene.Earth, Zone.InSituDefault)));
//
...
//            throw new MatrixException(MatrixException.Type.NetworkUnavailable_No_Return, Host.class, IndiciaKey.Focus.Assembly, Occurrence.Severity.Exceptional,e);
//        }
//    }
