...
public abstract class Predictor<DATUM,F extends Fact<F,I,X>,I extends Identity<I,X>,X extends Context<X>,P extends Model<F,?,I,X,?>,CRIT extends Criterion<DATUM,F,I,X>,PRE extends Predictor<DATUM,F,I,X,P,CRIT,PRE>> implements Comparable<PRE>, Serializable {
